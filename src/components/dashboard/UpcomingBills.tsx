  ...
  return (
    <Card className="flex flex-col p-6">
      <div className="mb-5 flex items-start justify-between">
        <div>
          <h2 className="text-lg font-semibold text-[var(--color-text-primary)]">Em tratamento</h2>
          <p className="mt-0.5 text-sm text-[var(--color-text-secondary)]">
            {count} animal(is) em acompanhamento
          </p>
        </div>
        <Link
          href="/animais"
          ...
          {bills.map((bill) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-[var(--color-text-primary)]">{bill.name}</p>
              ...
              <div className="shrink-0 text-right">
                <p className="text-sm font-semibold text-[var(--color-text-primary)]">{bill.amount}</p>
                <p className="mt-0.5 text-xs text-[var(--color-text-secondary)]">
                  {bill.date}
                </p>
              </div>
